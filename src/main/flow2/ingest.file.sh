...
groovy $(cygpath --windows "$flow2_home/instruction.groovy") -na $na -fileSet "$fileSet_windows" -autoIngestValidInstruction false -label "$folder $flow2_client" -notificationEMail $flow2_notificationEMail>>$log
